...
export class FederationDataSourceEditor extends DataSourceEditorBase {
    constructor(dsHelper, wizard, reportViewModel, undoEngine, itemsProvider, _rtl, _callbacks) {
        super(dsHelper, wizard, reportViewModel, undoEngine, itemsProvider);
        this._rtl = _rtl;
    ...
    getFederationDataSourceByInfo(dataSourceInfo) {
        ...
        ReportDataSourceService.federationDataSourceFromBase64(dataSourceInfo.data['base64'](), dataSourceInfo.data.dependentDataSources).done((result) => {
            var fieldListProvider = new FieldListProvider(this._callbacks.fieldListsCallback, rootManageQueriesDataSources, [new FederationDataSourceItemsExtender(rootManageQueriesDataSources)], true);
