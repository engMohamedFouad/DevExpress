...
export class ReportWizardService {
    static createNewWizardRequest(reportWizardState, requestType, state, customizeWizardModelAction, oldReportJSON) {
    ...
    static generateReportFromWizardState(reportWizardState, requestType, state, customizeWizardModelAction, oldReportJSON) {
        return ajax(HandlerUri(), 'generateReportFromWizardModel', this.createNewWizardRequest(reportWizardState, requestType, state, customizeWizardModelAction, oldReportJSON), ReportStorageWeb.getErrorMessageHandler());
    }
