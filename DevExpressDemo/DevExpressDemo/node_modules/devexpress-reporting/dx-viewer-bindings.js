...
addToBindingsCache('style: breakOffsetStyle(), text: field.editValue()', function ($context, $element) { return { 'style': function () { return $context.$data.breakOffsetStyle(); }, 'text': function () { return $context.$data.field.editValue(); } }; });
...
addToBindingsCache('dxCalendar: { value: value, cellTemplate: \'select_cell\', height: \'100%\', min: min }', function ($context, $element) { return { 'dxCalendar': function () { return { 'value': $context.$data.value, 'cellTemplate': 'select_cell', 'height': '100%', 'min': $context.$data.min }; } }; });
