...
import { ajax, AccordionKeyboardHelper } from '@devexpress/analytics-core/analytics-internal';
import { ParameterPanelItemBase as ParameterPanelItemBase } from './parameterPanelItemBase';
export class PreviewParametersViewModel extends ParameterPanelItemBase {
    constructor(reportPreview, parameterHelper, enableKeyboardSupport) {
        ...
        this.needToUpdateParameter = ko.observable(false);
