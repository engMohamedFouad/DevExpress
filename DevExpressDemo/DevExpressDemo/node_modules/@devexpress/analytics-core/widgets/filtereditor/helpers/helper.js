...
export class FilterEditorHelper {
    constructor(serializer) {
        ...
        this.filterEditorOperators.string = [].concat(this.filterEditorOperators._common, [
            ...
            { name: 'Is none of', _type: 'in', type: InOperator, reverse: true, localizationId: 'StringId.FilterClauseNoneOf' },
        ...
        this.filterEditorOperators.integer = [].concat(this.filterEditorOperators._common, [
            { name: 'Is null', insertVal: 'Is Null', value: UnaryOperatorType.IsNull, type: UnaryOperatorType, localizationId: 'StringId.FilterClauseIsNull' },
            { name: 'Is not null', insertVal: 'Is Not Null', value: UnaryOperatorType.IsNull, type: UnaryOperatorType, reverse: true, localizationId: 'StringId.FilterClauseIsNotNull' },
            { name: 'Is any of', _type: 'in', value: 'In', insertVal: 'In()', paramCount: 1, type: InOperator, localizationId: 'StringId.FilterClauseAnyOf' },
