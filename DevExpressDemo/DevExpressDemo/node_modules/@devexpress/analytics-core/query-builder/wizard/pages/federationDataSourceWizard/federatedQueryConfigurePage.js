...
export class FederatedQueryConfigurePage extends WizardPageBase {
    constructor(_options) {
        ...
        this._disposables.push(this._fieldListProvider = new FieldListProvider(this._wrapFieldListCallback(this._options.callbacks.fieldListsCallback), this._dataSources, [
